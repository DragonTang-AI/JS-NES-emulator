    ...
    cheats: [
      {
        ...
        name: "无限血（HP）",
        description: "角色不会掉血",
        codes: [{ address: 0x007A, value: 0x06 }],
      },
      {
        ...
        description: "购物升级不用愁",
        codes: [
          { address: 0x007C, value: 0x0F },
          { address: 0x007D, value: 0x27 },
        ],
      },
      {
        ...
        name: "闪烁无敌",
        description: "碰不到敌人",
        codes: [{ address: 0x0074, value: 0x55 }],
      },
      {
        id: "mitsume-all-weapons",
        name: "所有武器",
        description: "开局自带全套装备",
        codes: [{ address: 0x0081, value: 0x5F }],
      },
      {
        id: "mitsume-inf-life",
        name: "生命无限",
      ...
      },
      {
        ...
        codes: [{ address: 0x0527, value: 0x02 }],
      },
    ],
  },
  {
